...
const ACTIONS = {
  ...
  debtcollector: { name: "Debt Collector", value: 3, count: 3, text: "One player pays you $5" },
  birthday: { name: "It's My Birthday!", value: 2, count: 3, text: "Everyone pays you $2" },
  house: { name: "House", value: 3, count: 3, text: "Add $3 rent to a full set" },
  hotel: { name: "Hotel", value: 4, count: 2, text: "Add $4 rent to a set with a house" },
